      ...
      <div className="max-w-6xl mx-auto">
        <header className="mb-12 text-center">
          ...
          <p className="text-slate-500">
            Modern web teknolojileri üzerine notlar.
          </p>
        </header>
          ...
          {posts.map((post, index) => {
            ...
            return (
              ...
              >
                {/* Görsel Alanı */}
                <div
                  className={`relative w-full bg-slate-100 overflow-hidden ${isFeatured ? "h-80" : "h-44"}`}
                >
                  <Image
                ...
                {/* İçerik Alanı */}
                <div
                  className={`p-5 flex flex-col ${isFeatured ? "flex-grow" : ""}`}
                >
                  {/* 1. Tarih ve Kategori */}
